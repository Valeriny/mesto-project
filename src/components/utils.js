...
const buttonSaveFormEdit = document.querySelector("#save-button");
...
export { content, profileName, profileStatus, formEdit, formInput, buttonEdit, buttonSaveFormEdit, formProfileName, formProfileStatus, formAdd, buttonAdd, buttonCreateFormAdd, formNamePlace, formLinkPlace, initialCardsList, initialCardsTemplate, popupImage, photo, buttonsClose, photoTitle}